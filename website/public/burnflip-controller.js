...
(() => {
    ...
    const nextPaint = () => new Promise((resolve) => window.requestAnimationFrame(() => {
    ...
    async function animateOutcome(outcome, betId) {
        ...
        const headsFace = coin.querySelector(".burnflip-coin-heads");
        const tailsFace = coin.querySelector(".burnflip-coin-tails");
